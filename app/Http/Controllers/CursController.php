...
class CursController extends Controller
{
    ...
    public function store(Request $request){
        if(isset($_POST['btnsave'])){ //required|image|mimes:jpeg,png,jpg,gif,svg|max:2048
				...
				$NewCurso->duration = $request->duracion;	
				if($request->file('img')){ 
    ...
    public function update(Request $request, $id) {               
			if(isset($_POST['btnsave'])){  				
				...
				$update->duration = $request->duracion; 
        ...
        // $request->file('img')->resize(300,300);
