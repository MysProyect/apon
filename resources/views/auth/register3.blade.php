              ...
              <div class="form-group">
                ...
                <div  class="flex">
                    <div  class="">
                      ...
                      <select name="role" id="role" class="form-control" value="{{ old('role') }}"  onclick="userRole()">
                      ...
                      <strong class="privil display-7"> Nivel</strong>&nbsp;&nbsp;&nbsp;&nbsp;
                      <div class="">
                ...
                <!--         <select name="nivel"  class="form-control" value="{{ old('nivel') }}" id="nivel">
                      ...
                      <div class="img-rol-user" style="margin-left: 3%;">
                        <img src="{{asset('images/roles.png')}}"> 
                      </div>  
                  </div>
              ...
              @for($i=1; $i<=$n; $i++)          
                  <div class="form-group">
                    <select name="question_id" class="form-control" >
                        <option value="">Preguntas de seguridad - {{$i}}</option>
                      @foreach($quests as $q)
                        <option value="{{$q->id}}">{{$q->question}}</option>
                      @endforeach
                    </select>
                    <input type="text" name="answer" class="form-control" placeholder="Respuesta">
              @endfor
