 ...
 <div class="wrapper fadeInDown">
  ...
  <div id="formContent">
    ...
    <div class="">   
		  <div style="padding:2%;">
        <input type="login" id="login" wire:model="usuario" class="fadeIn second form-control display-4"  name="login" value="{{ old('usuario') }}" placeholder="Usuario" required autofocus><br>


        <input type="email" id="email" wire:model="email" class="fadeIn second form-control display-4"  name="email" value="{{ old('email') }}" placeholder="E-Mail" required autofocus><br> 



      <div class="form-group">
          <div>
            <label class="display-6">Password&nbsp;&nbsp;&nbsp; 
